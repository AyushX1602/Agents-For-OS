...
function executeAction(action, fsRoot, vars) {
  ...
  // Security: must stay within fsRoot. Use a path-separator boundary so a
  // sibling whose name merely shares the root's prefix (e.g. root "/x/spirit"
  // vs "/x/spirit-evil") can't slip through a bare startsWith() check.
