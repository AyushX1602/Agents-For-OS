...
// ── Auth guard ────────────────────────────────────────────────────────────────
// Resolve userId from session only. Never trust client-supplied ?user= query
// params — that would be a textbook IDOR: anyone could read/write another
// user's Known Book records by appending ?user=victim to the request.
