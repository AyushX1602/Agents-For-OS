...
function Toggle({ label, checked, onChange, icon, disabled }) {
  return (
    <button
      ...
      aria-label={label}
      className={`flex flex-col items-center justify-center gap-1.5 p-3 rounded-2xl text-[11px] font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-os-accent
