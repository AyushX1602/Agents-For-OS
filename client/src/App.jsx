...
function App() {
  ...
  // NOTE: Input toggles (gestureEnabled, voiceEnabled, eyeTrackingEnabled) are
  // persisted by osStore.partialize and default to false in the store definition.
  // No localStorage wipe needed here — doing so was resetting them on EVERY load.
